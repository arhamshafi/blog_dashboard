...
function Sign_up() {
  ...
  return (
    <div className='w-[400px] h-[500px] rounded-xl bg-white relative select-none '>
      ...
      <input type="text" className='w-[80%] pr-6  h-[30px] border-b border-gray-500 text-black font-bold  mx-auto  block mt-5 outline-none ' placeholder='Username' name='name' value={sign_up_form.name} onChange={Sign_up_handler} />
      <input type="email" className='w-[80%] pr-6 h-[30px] border-b border-gray-500 text-black font-bold  mx-auto block mt-5 outline-none placeholder:text-black/50 ' placeholder='E-Mail ' name='email' value={sign_up_form.email} onChange={Sign_up_handler} />
      ...
      <input type="number" className='w-[80%] pr-6 h-[30px] border-b border-gray-500 text-black font-bold  mx-auto block mt-5 outline-none placeholder:text-black/50 no_spinner ' placeholder='Phone Number ' name='number' value={sign_up_form.number} onChange={Sign_up_handler} />
      <input type="password" className='w-[80%] pr-6 h-[30px] border-b border-gray-500 text-black font-bold  mx-auto block mt-5 outline-none placeholder:text-black/50 ' placeholder='Password ' name='password' value={sign_up_form.password} onChange={Sign_up_handler} />
      ...
      <p className='text-center text-black/60 tracking-[-2px] mt-5 '>or login using</p>
